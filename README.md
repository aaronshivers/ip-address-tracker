...
Your challenge is to build out this IP Results Tracker app and get it looking as close to the design as possible. To get the IP Results locations, you'll be using the [IP Geolocation API by IPify](https://geo.ipify.org/). To generate the map, we recommend using [LeafletJS](https://leafletjs.com/).
